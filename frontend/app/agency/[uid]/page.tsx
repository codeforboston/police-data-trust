...
import ContentDetails from "@/components/Details/ContentDetails/ContentDetails"
...
export default function AgencyDetailsPage() {
  ...
  useEffect(() => {
    ...
    apiFetch(
      `${apiBaseUrl}${API_ROUTES.agencies.profile(uid)}?include=complaints&include=allegations&include=officers&include=units&include=most_complaints`,
      {
        headers: {
  ...
  return (
    <DetailsLayout sidebar={<ContentDetails agency={agency} />}>
      <AgencyIdentityCard {...agency} />
      <DetailsTabs {...agency} />
    </DetailsLayout>
  )
}
