...
const EditButton = (props: EditButtonProps) => {
  ...
  return (
    <button className={inEditMode ? editButtonOn : editButton} title="Edit Result Filter" onClick={onclick}>
...
const PageNavigator = (props: PageNavigatorProps) => {
  ...
  return (
    <div className={dataFooter}>
      ...
      <PageButton icon={faAngleDoubleLeft} onclick={() => gotoPage(0)} disabled={!canPreviousPage} />
      ...
      <PageButton icon={faAngleDoubleRight} onclick={() =>gotoPage(pageCount - 1)} disabled={!canNextPage} />
      <span className={goto}>
        Go to page:{" "}
        <input
          type="number"
