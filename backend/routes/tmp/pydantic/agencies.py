...
class Agency(BaseAgency, BaseModel):
    ...
    uid: Optional[str] = Field(
        None, description="Unique identifier for the agency"
    )
...
class BaseUnit(BaseModel):
    ...
    address: Optional[str] = Field(
        None, description="Street address of the unit"
    )
...
class Unit(BaseUnit, BaseModel):
    ...
    uid: Optional[str] = Field(
        None, description="Unique identifier for the unit"
    )
...
class AddOfficerFailed(BaseModel):
    officer_uid: Optional[str] = Field(
        None, description="The uid of the officer"
    )
