...
class LegalCase(db.Model):
    ...
    defendant_council = db.relationship('Attorney', backref='legal_case', uselist=False)
    plaintiff = db.Column(db.String)
    plaintiff_council = db.relationship('Attorney', backref='legal_case', uselist=False)
