import pytest
from backend.scraper.data_scrapers.mpv import *
from backend.scraper.data_scrapers.scraper_utils \
    import cols, map_cols, map_df, parse_int, strip_nan, isnan, nan_to_none

test_dataset = {"Original_Column_Name": "test"}
test_df = pd.DataFrame([test_dataset])
test_m = {"Original_Column_Name": "target_column_name", }
...
def test_cols():
    result = []
    result.append(cols())
    test_columns = ['source_id', 'victim_name', 'victim_gender', 'victim_race',
