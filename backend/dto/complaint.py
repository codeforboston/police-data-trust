...
from backend.dto.common import Attachment, RequestDTO


class CreateLocation(RequestDTO):
    location_type: Optional[str] = Field(
        None,
        description="The type of location. For example: Bar or Tavern, Street/Highway, etc.",
    )
    ...
    administrative_area: Optional[str] = Field(
        None,
        description="The administrative area this location is assigned by the local law enforcement agency.",
    )
    administrative_area_type: Optional[str] = Field(
        None,
        description="The type of administrative area. For example: Beat, Sector, Precinct, etc.",
    )
...
class CreateAllegation(RequestDTO):
    ...
    record_id: Optional[str] = Field(
        None,
        description="The ID that was given to this allegation by the original source of the data.",
    )
...
class CreateInvestigation(RequestDTO):
...
class CreateComplaintSource(RequestDTO):
...
class CreateComplaint(RequestDTO):
    ...
    record_id: Optional[str] = Field(
        None,
        description="The ID that was given to this complaint by the original source of the data.",
    )
...
class UpdateComplaint(RequestDTO):
    source_uid: str = Field(
        ..., description="The UID of the source making the update."
    )
    category: Optional[str] = Field(None, description="The category of the complaint.")
    incident_date: Optional[date] = Field(
        None, description="The date and time the incident occurred."
