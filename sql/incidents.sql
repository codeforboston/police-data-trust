...
CREATE TABLE public.incidents (
	...
	"Charges_Involved" varchar(512) NULL,
	...
	"Associated_Incidents" varchar(512) NULL,
	"Death_Date" timestamp NULL,
	"Death_State_Abbv" varchar(512) NULL,
	"Death_City" varchar(512) NULL,
	"Death_Address_1" varchar(512) NULL,
	"Death_Address_2" varchar(512) NULL,
	"Death_Zip_Code" text NULL,
	"Cause_Of_Death" cause_of_death_enum NULL,
	"Cause_Of_Death_Description" varchar(512) NULL,
	...
	"Agency_ID" int4 NULL,
	"Agency_Name" varchar(512) NULL,
	"Agency_State_Abbv" varchar(512) NULL,
	"Agency_City" varchar(512) NULL,
	"Agency_Address_1" varchar(512) NULL,
	"Agency_Address_2" varchar(512) NULL,
